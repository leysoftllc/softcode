...
const MODE_SYSTEM: Record<Mode, string[]> = {
    ...
    edit: [
        ...
        'The opening fence MUST contain only the language name and then a newline. Do not put the file path on the same line as the opening fence.',
        'Example:',
        '```typescript',
        '// @@softcode-edit: src/utils/helpers.ts',
        '// full new file content here…',
        '```',
        'Do not output patch prose instead of edit blocks. If the user asks to fix, apply, update, or says yes to generated fixes, produce edit blocks.',
